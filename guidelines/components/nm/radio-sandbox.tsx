...
type Selection = 'off' | 'on';
type State = 'default' | 'hover' | 'readonly';
type Bg = 'light' | 'dark';

export function RadioSandbox() {
  const [selection, setSelection] = useState<Selection>('on');
  const [state, setState] = useState<State>('default');
  const [label, setLabel] = useState('Email me updates');
  ...
  const cls = ['nm-radio', ...(state === 'readonly' ? ['is-readonly'] : [])].join(' ');
  ...
  const codeAttrs = state === 'readonly' ? ' is-readonly' : '';
  const codeExtra = [
  ...
  return (
    <div className="sandbox">
      ...
      <div className="code">
        ...
        <span className="tok-str">&quot;radio&quot;</span> <span className="tok-attr">name</span>=
        <span className="tok-str">&quot;plan&quot;</span> <span className="tok-attr">class</span>=
        <span className="tok-str">&quot;nm-radio{codeAttrs}&quot;</span>
        {codeExtra}
        <span className="tok-tag">&gt;</span>
        {'\n  '}
